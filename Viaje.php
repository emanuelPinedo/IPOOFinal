...
class Viaje{
        ...
        if ($base->Iniciar()) {
            if ($base->Ejecutar($consultaPasajeros)) {
                while ($row = $base->Registro()) {
                    ...
                    $documento = isset($row['pdocumento']) ? $row['pdocumento'] : '';//Si un valor no existe de algun row, se asigna vacio.
    ...
    public function insertar() {
        ...
        if ($this->getObjEmpresa() != null && $this->getObjResponsable() != null) {
            ...
            $consultaInsert = "INSERT INTO viaje(vdestino, vcantmaxpasajeros, idempresa, rnumeroempleado, vimporte) 
                               VALUES ('" . $this->getVDestino() . "', " . $this->getVCantMaxPasajeros() . ", " . $this->getObjEmpresa()->getIdEmpresa() . ", " . $this->getObjResponsable()->getNroEmpleado() . ", " . $this->getVImporte() . ")";
            if ($base->Iniciar()) {
    ...
    public function modificar(){
        ...
        $base = new BaseDatos();
        //BUSCAR DSP EJECUTAR
        $consultaUpdate = "UPDATE viaje SET vdestino='" . $this->getVDestino() . "', vcantmaxpasajeros='" . $this->getVCantMaxPasajeros() . "', idempresa='" . $this->getObjEmpresa()->getIdEmpresa() . "', rnumeroempleado='" . $this->getObjResponsable()->getNroEmpleado() . "', vimporte='" . $this->getVImporte() . "' WHERE idviaje=" . $this->getIdViaje();
